...
static pinmuxReg_t *pinmuxReg = (pinmuxReg_t *)LOGI_ADDR_PIMUX_REG;
...
)
{
    ...
    UINT32 regVal;
	pinMuxMask_t *pinMux,special_pinMux={0};
    ...
    /* Pin Mux configure */
  if((ch==1)&&(pin==17)) //IOB17 special 
  {
  		special_pinMux.clearMask = PINMUX_00_ARMJTAG|PINMUX_15_I2S;
  		special_pinMux.setMask[0]=PINMUX_00_ARMJTAG;
  		special_pinMux.setMask[1]=PINMUX_15_I2S;
  		special_pinMux.setMask[2]=0;
  		special_pinMux.setMask[3]=0;
  		pinMux =&special_pinMux;
  }
  else	
