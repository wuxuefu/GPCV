...
void gpHalDisp2SetD1Position(UINT32 enable);
void gpHalDisp2Set576Mode(UINT32 enable);
void gpHalDisp2Set480IMode(UINT32 enable);
void gpHalDisp2Set720PMode(UINT32 enable);
