...
#define PA_READ8(_reg_)            (*((volatile UINT8  *)(ioremap((_reg_),4))))
#define PA_READ16(_reg_)           (*((volatile UINT16 *)(ioremap((_reg_),4))))
#define PA_READ32(_reg_)           (*((volatile UINT32 *)(ioremap((_reg_),4))))
#define PA_WRITE8(_reg_, _value_)  (*((volatile UINT8  *)(ioremap((_reg_),4))) = (_value_))
#define PA_WRITE16(_reg_, _value_) (*((volatile UINT16 *)(ioremap((_reg_),4))) = (_value_))
#define PA_WRITE32(_reg_, _value_) (*((volatile UINT32 *)(ioremap((_reg_),4))) = (_value_))
