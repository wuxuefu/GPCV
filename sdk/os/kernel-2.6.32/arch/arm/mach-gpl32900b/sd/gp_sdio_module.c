...
/**
 * @brief   SDIO platform device release function
 */
static void gp_sdio_release(struct device *pdev)
{
	...
	UINT32 ocr)
{
    ...
    memset(&gp_sdio_device, 0, sizeof(struct platform_device));
    
    gp_sdio_device.name = DRIVER_NAME;
    gp_sdio_device.id = 1;
    gp_sdio_device.dev.platform_data = &gp_sdio_platdata;
    gp_sdio_device.dev.dma_mask = &gp_sdio_dma_mask;
    gp_sdio_device.dev.coherent_dma_mask = DMA_BIT_MASK(32);
    gp_sdio_device.dev.release = gp_sdio_release;
