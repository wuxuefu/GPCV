...
static signed int pos_temp = 0xF003;
...
{
	int32_t mode,non_interlace_bit,error;

	mode = *(uint32_t *) data;
  non_interlace_bit = mode;
  mode &=~0x80000000;
  non_interlace_bit &=0x80000000;  
  error = 0;
#if 1 
       switch(mode)
       {
          case SP_DISP_TV_MODE_NTSC:
								gPanelInfo.resolution = HAL_DISP2_RES_720_480;
								...
								gpHalDisp2SetHPosition(gPanelInfo.hPosition);
								gpHalDisp2SetVideoDac(gPanelInfo.videoDac);          
                gpHalDisp2SetD1Position(1); 
                break;
          
          case SP_DISP_TV_MODE_PAL:
								gPanelInfo.resolution = HAL_DISP2_RES_720_480;
								gPanelInfo.tvType = HAL_DISP2_TV_MODE_RESERVED;
								gPanelInfo.interlace = HAL_DISP2_TV_INTERLACE;
								gPanelInfo.saturation = 0x815E;
								...
								gPanelInfo.sharpness = 0x0000;
								gPanelInfo.yGain = 0x6D4E;
								gPanelInfo.yDelay = 0x27F0;
								gPanelInfo.vPosition = 0xA500;
								gPanelInfo.hPosition = 0xF007;
								pos_temp = 0xF007;
								gPanelInfo.videoDac = 0x2100;	
								gpHalDisp2SetRes(gPanelInfo.resolution);
								gpHalDisp2SetTvType(gPanelInfo.tvType);
          ...
          case SP_DISP_TV_MODE_NTSC_J:
								...
								gPanelInfo.sharpness = 0x0000;
								gPanelInfo.yGain = 0x6D4E;
								gPanelInfo.yDelay = 0xB800;
								gPanelInfo.vPosition = 0x1E00;
								gPanelInfo.hPosition = 0xF0F6;
								pos_temp = 0xF003;
								gPanelInfo.videoDac = 0x2100;	
								gpHalDisp2SetRes(gPanelInfo.resolution);
          ...
          case SP_DISP_TV_MODE_V_576:
                gpHalPPUSet576mode(gPanelInfo.resolution);
                gpHalDisp2Set576Mode(1);
                break;
             
          case SP_DISP_TV_MODE_NTSC_NON_INTERLACE:
								gPanelInfo.resolution = HAL_DISP2_RES_720_480;
								gPanelInfo.tvType = HAL_DISP2_TV_MODE_RESERVED;
							  if(!non_interlace_bit)	
									gPanelInfo.interlace = HAL_DISP2_TV_INTERLACE;
							  else	
									gPanelInfo.interlace = HAL_DISP2_TV_NONINTERLACE;	
								gPanelInfo.saturation = 0x815E;
								gPanelInfo.hue = 0x5A00;
								gPanelInfo.brightness = 0x7600;
								gPanelInfo.sharpness = 0x0000;
          ...
          case SP_DISP_TV_MODE_PAL_NON_INTERLACE:
							 gPanelInfo.resolution = HAL_DISP2_RES_720_480;
							 gPanelInfo.tvType = HAL_DISP2_TV_MODE_RESERVED;
							 if(!non_interlace_bit)
								gPanelInfo.interlace = HAL_DISP2_TV_INTERLACE;
          ...
          case SP_DISP_TV_MODE_VGA:
                gpHalDisp2SetEnable(0);
                gPanelInfo.resolution = HAL_DISP2_RES_640_480;
                gpHalDisp2SetRes(gPanelInfo.resolution);
                gpHalDisp2SetD1Position(0);
                gPanelInfo.hPosition = pos_temp;
                gpHalDisp2SetHPosition(gPanelInfo.hPosition);
                gpHalDisp2SetEnable(1); 
                break;          
             
          case SP_DISP_TV_MODE_QVGA:
                gpHalDisp2SetEnable(0);
                gPanelInfo.resolution = HAL_DISP2_RES_320_240;
                gpHalDisp2SetRes(gPanelInfo.resolution);          
                gpHalDisp2SetD1Position(0);
                gPanelInfo.hPosition = pos_temp; 
                gpHalDisp2SetHPosition(gPanelInfo.hPosition);
          ...
          case SP_DISP_TV_MODE_480I:
                gpHalDisp2Set480IMode(1);
                gpHalPPUSet576mode(0);
                break;
          
          case SP_DISP_TV_MODE_720P:
                gpHalDisp2Set720PMode(1);
                gpHalPPUSet576mode(1280);
                break;
