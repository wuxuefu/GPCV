...
void gpHalI2sClkEn(int enable)
{
	...
	if(enable) {
		gp_clk_set_parent( (int*)"clk_ref_audio", (int*)"apll" );
		gp_clk_set_parent( (int*)"clk_ref_i2s", (int*)"apll" );
	} else {
		gp_clk_set_parent( (int*)"clk_ref_audio", (int*)"xtal" );
		gp_clk_set_parent( (int*)"clk_ref_i2s", (int*)"xtal" );		
	}
	
	gp_enable_clock( (int*)"I2S", enable );
	gp_enable_clock( (int*)"I2SRX", enable );
