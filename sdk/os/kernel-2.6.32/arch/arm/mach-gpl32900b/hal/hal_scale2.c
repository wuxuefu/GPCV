...
static UINT8 scaler_started = 0;
static UINT8 scaler_bypass_zoom_mode = 0;
...
/**
* @brief	scale2 output size get 
* @param 	width[out]: 
* @param 	height[out]: 
* @return 	SUCCESS/ERROR
*/
SINT32 
gpHalScale2GetOutputPixel(
	UINT32 *width, 
	UINT32 *height  
)
{
	*width = scale2Reg->scale2OutWidth;
	*height = scale2Reg->scale2OutHeight;
	return 0;
}
...
/**
* @brief	scale2 output address get 
* @param 	y_addr[out]: 
* @param 	u_addr[out]: 
* @param 	v_addr[out]: 
* @return 	SUCCESS/ERROR
*/
SINT32 
gpHalScale2GetOutputAddr(
	UINT32 *y_addr, 
	UINT32 *u_addr, 
	UINT32 *v_addr 
)
{
	*y_addr = scale2Reg->scale2OutYAddr;
	*u_addr = scale2Reg->scale2OutUAddr;
	*v_addr = scale2Reg->scale2OutVAddr;
	return 0;
}
...
/**
* @brief	scale2 output format get 
* @param 	
* @return 	format
*/
UINT32 
gpHalScale2GetOutputFormat(
	void
)
{
	UINT32 reg = scale2Reg->scale2Ctrl;

	reg &= C_SCALE2_CTRL_OUT_MASK;
	return reg;
}
...
/**
* @brief	scaler2 output fifo size get 
* @param 	
* @return 	mode
*/
UINT32
gpHalScale2GetOutputFifoSize(
	void
)
{
	UINT32 reg = scale2Reg->scale2Ctrl;
	
	reg &= C_SCALE2_CTRL_OUT_FIFO_LINE_MASK;
	return reg;
}
...
{
	gp_enable_clock( (int*)"SCALER2", enable );
}
