...
/**
 * @brief dc2dc dev infomation register function
 * @param dc2dc_dev [in] dc2dc dev handle
 * @return success: 0,  erro: ERROR_ID
 */
static int gp_dc2dc_register_device(void)
{
	int ret;
...
/**
 * @brief dc2dc dev infomation unregister function
 * @param dc2dc_dev [in] dc2dc dev handle
 * @return success: 0,  erro: ERROR_ID
 */
static int gp_dc2dc_unregister_device(void)
{
	gp_board_pin_func_release(gp_dc2dc_data.pin_handle);
	
	return 0;
}

/**
 * @brief   dc2dc device register
 */
int gp_dc2dc_device_register(void)
{
	return gp_dc2dc_register_device();
}
EXPORT_SYMBOL(gp_dc2dc_device_register);

/**
 * @brief   dc2dc device unregister
 */
void gp_dc2dc_device_unregister(void)
{
	gp_dc2dc_unregister_device();
}
EXPORT_SYMBOL(gp_dc2dc_device_unregister);
