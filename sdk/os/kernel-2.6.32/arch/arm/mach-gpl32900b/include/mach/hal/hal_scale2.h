...
* @return 	SUCCESS/ERROR
*/
SINT32 gpHalScale2GetOutputPixel(UINT32 *width, UINT32 *height);
...
* @return 	SUCCESS/ERROR
*/
SINT32 gpHalScale2GetOutputAddr(UINT32 *y_addr, UINT32 *u_addr, UINT32 *v_addr);
...
* @return 	format
*/
UINT32 gpHalScale2GetOutputFormat(void);
...
* @return 	mode
*/
UINT32 gpHalScale2GetOutputFifoSize(void);
