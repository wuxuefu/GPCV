...
#define	LOGI_ADDR_CSI1_REG		(IO3_BASE + 0x20238)
/**************************************************************************
 *                          D A T A    T Y P E S                          *
 **************************************************************************/
typedef struct csi1Reg_s {
	volatile UINT32 TGRIRQStatus; /* 0x0238 */
	volatile UINT32 TGRIRQEn;	/* 0x023C */
	...
	volatile UINT32 rsv08c;     /* 0x006C ~ 0x006F */
	volatile UINT32 csijpegbyte;    /* 0x0070 ~ 0x0073 */
} csi1Reg_t;                   
