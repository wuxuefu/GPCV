...
/** 
 * @brief clock group sructure
 * @param : ref_clock : clock_xxx_ref
 * @param : base_clock : clock_xxx
 * @param : ahb_clock : clock_xxx_ahb
 * @param : apb_clock : clock_xxx_apb
 */
typedef struct gp_clock_group_s {
	int 	ref_clock ;
	int 	base_clock;
	int 	ahb_clock ;
	int 	apb_clock ;
...
* @return 	SUCCESS/FAIL.
*/
int gp_clk_set_rate(int *clock_name, unsigned long freq );
