...
/* cmos sensor status */
#define CMS_IDLE				0
#define CMS_RUNING				(1 << 0)
#define CMS_I2C_FAIL			(1 << 1)
#define CMS_I2C_TIMEOUT			(1 << 2)

typedef enum
{	
	MSG_CSI_MAX = 0x10000000,
}MSG_CSI_CTRL_ID;
/**************************************************************************
 *                              M A C R O S                               *
 **************************************************************************/
...
typedef struct gpCsiMclk_s
{
	...
	unsigned char	mclk_sel;		/* 0: spll(ceva), 1: usb */
...
#define VIDIOC_G_CMS_STS 	_IOWR('V', BASE_VIDIOC_PRIVATE+6, int)
#endif
