...
#define RTC_ADJUST_MARCO	    (0x4)
#define RTC_LOAD_START_VALUE_MARCO    (0x5)
#define RTC_SNAP_TIMER_VALUE_MARCO    (0x6)
#define RTC_INTR_STATUS_MARCO      	 	(0x7)
#define RTC_INTR_ENABLE_MARCO      	 	(0x8)
...
#if 1
#define RTC_TIMERCNT_7_0_MARCO   (0x30)   /*The counting value of the timer*/
#define RTC_TIMERCNT_15_8_MARCO  (0x31)
#define RTC_TIMERCNT_23_16_MARCO (0x32)
#define RTC_TIMERCNT_31_24_MARCO (0x33)
#define RTC_TIMERCNT_39_32_MARCO (0x34)
#define RTC_TIMERCNT_47_40_MARCO (0x35)

#else	
/*Keep logical identifier for timercnt, in 32900 it is same as LOADCNTBIT in phy*/
...
#define RTC_DUMMY_0 (0x40) 	/*served area*/
#define RTC_DUMMY_1 (0x41) 
...
extern void gpHalRtcDummyWrite(UINT16 value);

extern UINT16 gpHalRtcDummyRead(void);	
