...
#define CSI_OF				(1<<0)
#define CSI_HOLD			(1<<1)
#define CSI_FRAME_END		(1<<2)
#define CSI_LAST_LINE		(1<<6)
#define CSI_CTRLREG_UPDATE	(1<<7)
...
void gpHalCsiSetIRQ(UINT32 bits, UINT32 enable);
...
void gpHalCsiSetEnable(UINT32 enable);
