...
{
	unsigned int MDEn;			/* 0: disable, 1: enable,*/	
	unsigned int MDBlk8x8;		/* 0: MD_16x16, 1: MD_8x8 */
	unsigned int MDMode;		/* 0: MD_AVG, 1: MD_SINGLE, 2: MD_AVG_IIR, 3: MD_SINGLE_IIR */ 	
	unsigned int MDYUV;			/* 0: MD_DATA_RGB, 1: MD_DATA_YUV */
	unsigned int MDVGA;			/* 0: MD_QVGA_SIZE, 1: MD_VGA_SIZE only support 16x16*/
	unsigned int MDFrame;		/* 0: MD_EVERY1, 1: MD_EVERY2, 2:MD_EVERY4, 3: MD_EVERY8 */
	unsigned int threshold;		/* 0x00 ~ 0x7F */
	unsigned int MD_X_Width;	/* 0x00 ~ 0x3F */
	unsigned int MD_Y_Width;	/* 0x00 ~ 0x3F */
    
	unsigned int hpos;			/* 0x00 ~ 0x3FF */		
	unsigned int vpos;			/* 0x00 ~ 0x3FF */
}gpCsi1MD_t;
