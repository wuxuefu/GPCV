 ...
 *                           C O N S T A N T S                            *
 **************************************************************************/
#define LOGI_ADDR_MIPI_PPU_REG      IO3_ADDRESS(0xD000)
#define LOGI_ADDR_MIPI_CDSP_REG		IO2_ADDRESS(0x16000)
#define LOGI_ADDR_MIPI_REG			LOGI_ADDR_MIPI_PPU_REG
...
typedef struct mipiReg_s 
{
	...
	volatile UINT32 reserved4[0x0F];	/* reserved, 0x9300D044 */
	volatile UINT32 mipiIntSource;		/* R_MIPI_INTERRUPT_SOURCE, 0x9300D080 */
	volatile UINT32 reserved5[0x0F];	/* reserved, 0x9300D084 */
