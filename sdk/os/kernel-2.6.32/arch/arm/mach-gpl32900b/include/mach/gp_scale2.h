...
#define SCALE2_IOCTL_S_START_WITHOUT_WAIT	_IOW(SCALE2_IOCTL_ID, 7, gpScale2Format_t)
#define SCALE2_IOCTL_G_STATUS	_IOW(SCALE2_IOCTL_ID, 8, int)

extern void *gp_scale2_request(void);
extern void gp_scale2_release(void *handle);
extern int gp_scale2_lock(void *handle);
extern int gp_scale2_unlock(void *handle);
extern gpScale2Format_t *gp_scale2_get_fmt_struct(void *handle);
extern gpScale2Para_t *gp_scale2_get_para_struct(void *handle);
extern void gp_scale2_stop(void *handle);
extern int gp_scale2_trigger(void *handle);
extern int gp_scale2_retrigger(void *handle);
#endif /* _GP_SCALE2_H_ */
