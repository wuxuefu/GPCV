...
#define SRAM_SIZE		0x0000C000                 // How much?  //give 1M size mapping
...
#define SOC_BAK_BASE	0xfe000000               // VA of IO 
#define SOC_BAK_SIZE	0x00014000               // How much?
//#define SOC_BAK_START	0x00001000                 // PA of IO
#define SOC_BAK_START	0x00100000               // PA of IO
...
#define CPU_REG_BASE				(CONFIG_PAGE_OFFSET + 0x00100000)
#define CPU_REG_SIZE				0x20000
#define CPU_REG_START				0x00100000

#define SND_LOADER_BASE			(CONFIG_PAGE_OFFSET + 0x00120000)
#define SND_LOADER_SIZE			0x32000
#define SND_LOADER_START		0x00120000

#define LAODER_DEV_BASE			(CONFIG_PAGE_OFFSET + 0x00140000)
#define LAODER_DEV_SIZE			0x200
#define LAODER_DEV_START		0x00140000
