...
typedef enum gpApbdma0Module_e{
	...
	SD1,								/*!< @brief SD card 1 module */
	SD2,								/*!< @brief SD card 2 module */
	UART0,								/*!< @brief UART 0 module */
	UART1,								/*!< @brief UART 1 module */
	SPI0,								/*!< @brief SPI 0 module */
	SPI1,								/*!< @brief SPI 1 module */
	I2C,								/*!< @brief I2C module */
	TI2C,								/*!< @brief TI2C module */
} gpApbdma0Module_t;
