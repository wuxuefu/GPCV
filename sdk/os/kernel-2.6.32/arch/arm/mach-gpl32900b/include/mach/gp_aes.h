...
typedef struct gpAesPara_s 
{
	...
	unsigned int reorder_key;
	unsigned int reorder_input;
	unsigned int reorder_output;
} gpAesPara_t;


enum {
	GP_AES_REORDER_GROUP_0 = 0x0001,
	GP_AES_REORDER_GROUP_1 = 0x0002,
	GP_AES_REORDER_GROUP_2 = 0x0004,
	GP_AES_REORDER_GROUP_3 = 0x0008,
	GP_AES_REORDER_GROUP_ALL = 0x0010,
};
...
#define AES_IOCTL_S_DECRYPT_REORDER		_IOW(AES_IOCTL_ID, 2, gpAesPara_t)
#define AES_IOCTL_S_ENCRYPT_REORDER		_IOW(AES_IOCTL_ID, 3, gpAesPara_t)
