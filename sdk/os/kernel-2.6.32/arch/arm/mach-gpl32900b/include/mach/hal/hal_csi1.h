...
#else 
#define CSI1_FRAME_END			(1<<0)
#define CSI1_MOTION_DECT		(1<<1)
#define CSI1_POST_HIT			(1<<2)
#define CSI1_MD_UNDER_RUN		(1<<3)
#define CSI1_UNDER_RUN			(1<<4)
#endif
...
#define JPEG_MODE_EN  		(1<<18)			// Jpeg Valid mode enable bit
...
void gpHalCsi1SetMDEn(UINT8 MD_En);
void gpHalCsi1SetMD(UINT8 MD_Frame, UINT8 MD_VGA, UINT8 MD_yuv,
					UINT8 MD_mode, UINT8 MDBlk8x8, UINT8 threshold);
void gpHalCsi1SetMDHVPos(UINT16 md_h_pos, UINT16 md_v_pos);
void gpHalCsi1SetMDArbRes(UINT16 md_h_ArbRes,UINT16 md_v_ArbRes);
void gpHalCsi1SetMDFbAddr(UINT32 md_fb_addr); 
void gpHalCsi1SetJpegModeEn(UINT32 enable);
UINT32 gpHalCsi1Getjpegbyte(void);
#endif
