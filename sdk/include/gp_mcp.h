...
#define MCP_VOUT_TYPE_DSUB            VO_TYPE_DSUB  /** @brief MCPlayer video out to disp0 device */
#define MCP_VOUT_TYPE_HDMI0           VO_TYPE_HDMI0  /** @brief MCPlayer video out to HDMI0 device */
 ...
 ***************************************************************************/
	...
	typedef enum {
		...
		MCP_RET_NOCHUNKMEM	 = -10	 /*!> no chunk memory error  */
	}mcpRet_e;
	...
	typedef struct mcpMediaInfo_s 
	{
		...
		UINT32 clientId; /*!< [in] client id, gplus is 0 */
		UINT32 esBufSize; /*!< [in] element stream buffer size */
 ...
 ***************************************************************************/
	...
	SINT32 mcpPlayNext(SINT8 *moive, UINT32 ms);
	...
	typedef enum mcpParamType_e{
		...
		MCP_PARAM_CREATE_IDX,		  /*!> set: create index table if it don't exist in movie */
		...
		MCP_PARAM_VID_ESBUF_SIZE,	  /*!> set: element stream buffer size */
		MCP_PARAM_VID_ES_CONTINUE,	  /*!> set: continue read video file stream */
		MCP_PARAM_VID_ES_BUFFER,	  /*!> get: video file stream buffer */
		...
		MCP_PARAM_SUB_ATTR_EN,       /*!> get/set: char attribute enable/disable*/		
		MCP_PARAM_SUB_CHAR_SIZE,	  /*!> set: txt char size */
		MCP_PARAM_SUB_CHAR_OPCITY,	  /*!> set: txt char opacity */
		MCP_PARAM_SUB_CHAR_COLOR,	  /*!> set: txt char color */
		MCP_PARAM_SUB_EDGE_ATTR,	  /*!> set: txt char edge attribute */
		MCP_PARAM_SUB_BG_OPCITY,	  /*!> set: txt background opcity */
		MCP_PARAM_SUB_BG_COLOR,		  /*!> set: txt background color */
		MCP_PARAM_SUB_WINDOW_OPCITY,	  /*!> set: txt window opcity */
		MCP_PARAM_SUB_WINDOW_COLOR,		  /*!> set: txt window color */
		MCP_PARAM_SUB_TTF,		  	  /*!> /get/set: font styles ttf path */
...
extern "C" {
	...
	extern UINT32 mcp_hw_version;
	#define MCP32900	(mcp_hw_version == MACH_GPL32900)
	#define MCP32900B	(mcp_hw_version == MACH_GPL32900B)
#ifdef __cplusplus
	}
#endif
