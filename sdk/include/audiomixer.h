...
/* default sample rate for the audiomixer server */
...
#define AUDIOMIXER_SOCKET "/audiomixer_socket"

/* OSS blk info */
#define AUDIOMIXER_DEFAULT_BLK_NUM	8
#define AUDIOMIXER_DEFAULT_BLK_SIZE	12	/* 2 ^ 12 = 4096 Bytes */

/*************************************/
/* what can we do to/with the Audiomixer */
enum audiomixer_proto { 
    ...
    AUDIOMIXER_PROTO_CTRL_SET_OUTPUT_PATH,
...
int audiomixer_ctrl_set_output_path(audiomixer_ctrl_t* handle, int path);
