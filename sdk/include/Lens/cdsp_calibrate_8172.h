...
#ifndef _CDSP_CALIBRATE_8172_H_
#define _CDSP_CALIBRATE_8172_H_
...
static const unsigned short g_ar0330_lens_topfuture_r_b_gain[71][2] = 
{ // { r gain, b gain }  
{39, 222},
{42, 217},
{44, 212},
...
static const short g_ar0330_lens_topfuture_color_matrix4gamma045[9] = 
{	
	(short) ((1.43982993066530090000 *64) + 0.5),
	(short) ((-0.40574745569772269000 *64) + 0.5),
	(short) ((-0.03408247496757815800 *64) + 0.5),
	(short) ((-0.23659928474934369000 *64) + 0.5),
	(short) ((1.18011275846028330000 *64) + 0.5),
	(short) ((0.05648652628906061800 *64) + 0.5),
	(short) ((0.03454549175689899200 *64) + 0.5),
	(short) ((-0.82641921086997405000 *64) + 0.5),
	(short) ((1.79187371911307510000 *64) + 0.5)
};

static const unsigned int g_ar0330_lens_topfuture_gamma_table_test[] = 
{
#if 0
0x14540e, 0x114513, 0x051419, 0x14511e, 0x145123, 0x145128, 0x04512d, 0x051132, 
0x114437, 0x04513b, 0x144440, 0x111144, 0x111148, 0x04444d, 0x044451, 0x111055, 
0x111158, 0x04115c, 0x104460, 0x011163, 0x104467, 0x04116a, 0x01106e, 0x110471, 
0x104474, 0x104477, 0x10447a, 0x11047d, 0x010480, 0x041083, 0x104185, 0x010488, 
0x04108b, 0x01018d, 0x101090, 0x010492, 0x104194, 0x101097, 0x040499, 0x01019b, 
0x00419d, 0x0040a0, 0x0040a2, 0x1010a4, 0x1010a6, 0x0040a8, 0x0040aa, 0x0040ac, 
0x0100ae, 0x0101af, 0x0404b1, 0x1004b3, 0x0010b5, 0x0040b7, 0x0101b8, 0x0404ba, 
0x0010bc, 0x0040be, 0x0101bf, 0x1004c1, 0x0010c3, 0x0040c5, 0x0401c6, 0x1004c8, 
0x0010ca, 0x0040cc, 0x0101cd, 0x0404cf, 0x1010d1, 0x0040d3, 0x0040d5, 0x0101d6, 
0x0101d8, 0x0401da, 0x0404dc, 0x0404de, 0x0404e0, 0x0104e2, 0x0101e4, 0x0101e6, 
0x0040e9, 0x1010eb, 0x0404ed, 0x0101ef, 0x1010f2, 0x0104f4, 0x1040f7, 0x0104f9, 
0x0410fc, 0x0001fe, 0x0000ff, 0x0000ff, 0x0000ff, 0x0000ff, 0x0000ff, 0x0000ff, 
...
static const short g_ar0330_lens_topfuture_awb_thr[19] = 
{
	200, // awbwinthr
...
// ar0330 max exposure time: 360 
// wb r gain: 93, b gain: 92
sensor_calibration_t ar0330_cdsp_calibration = 
{
	...
	.wb_gain = g_ar0330_lens_topfuture_r_b_gain,
	.wbgain_size = sizeof(unsigned short)*71*2,
	.gamma1 = g_ar0330_lens_topfuture_gamma_table_test,
	.gamma1_size = sizeof(unsigned int)*128,
	.color_matrix1 = g_ar0330_lens_topfuture_color_matrix4gamma045,
	.matrix1_size = sizeof(short)*9,
	.gamma2 = g_ar0330_lens_topfuture_gamma_table_test,
	.gamma2_size = sizeof(unsigned int)*128,
	.color_matrix2 = g_ar0330_lens_topfuture_color_matrix4gamma045,
	.matrix2_size = sizeof(short)*9,
	.awb_thr = g_ar0330_lens_topfuture_awb_thr,
