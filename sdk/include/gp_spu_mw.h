...
extern void SPU_MIDI_UNINIT(SINT32 handle);
...
extern void SPU_fun_SUSPEND(SINT32 handle);
extern void SPU_fun_RESUME(SINT32 handle);
...
extern void SPU_SET_DRM_VOL_MW(SINT32 handle,  STRUCT_DRM_SPU *p_drm_struct);
extern void SPU_STOP_CHANNEL_MW(SINT32 handle,  unsigned int channel);
extern void SPU_PAUSE_CHANNEL_MW(SINT32 handle,  unsigned int channel);
extern void SPU_RESUME_CHANNEL_MW(SINT32 handle,  unsigned int channel);
extern UINT32 SPU_GET_CHANNEL_STATUS_MW(SINT32 handle, unsigned int channel);
...
extern SINT32 SPU_GET_MIDI_NUMBER_MW(SINT32 handle, UINT32 midi_index);
