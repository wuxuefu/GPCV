...
TARGET_TOOLS_PREFIX := arm-buildroot-linux-uclibcgnueabi-
endif
ifeq ($(SYSCONFIG_TOOLCHAIN_SEL), musl)
TARGET_TOOLS_PREFIX := arm-buildroot-linux-musleabi-
endif
...
ifeq ($(SYSCONFIG_ARCH_GPL32900B),y)
KERNEL_INCLUDE += -I$(KERNEL_HEADERS)/arch/arm/mach-gpl32900b/include
endif
