...
#define	usb_slave_detect_power_channel		GPIO_CHANNEL_0
#define	usb_slave_detect_power_func			1
#define	usb_slave_detect_power_gid			31
#define	usb_slave_detect_power_pin			30
...
#define tv_detect_channel		0xff //IOC14
